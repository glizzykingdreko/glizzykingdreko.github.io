...
const menus = {
    main: `Select a menu:<br><span onclick="handleMenuClick('1')">[1] Who is glizzy?</span><br><span onclick="handleMenuClick('2')">[2] Contact me</span><br><span onclick="handleMenuClick('3')">[3] My works</span>`,
    '1': `Who is Glizzy?<br><br>I've been a software developer for several years. My journey into the tech world began by providing Minecraft mods, hacked clients, and building online forums. As my interests shifted to the sneaker market, I channeled my skills into web automation and reverse engineering. This led me to work extensively with sneaker bots, tools, and monitors, a niche where I contributed significantly. <br><br>Following my stint with sneakers, I delved into the GPU/NFT reselling scene. Nowadays, my expertise lies in bypassing antibots and dabbling in ticket reselling. I proudly helm <a href="https://takionapi.tech">TakionAPI</a>, an industry-leading antibot bypass provider that caters to a multitude of protections.<br><br><span onclick="handleMenuClick('B')">[B] Back</span>`,
    '2': `Contact:<br>- Email: <a href="mailto:glizzykingdreko@protonmail.com">glizzykingdreko@protonmail.com</a><br>- Discord: <a href="https://discord.com/users/884890628511633459">@glizzykingdreko</a><br><br><span onclick="handleMenuClick('B')">[B] Back</span>`,
